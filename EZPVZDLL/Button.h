...
DWORD APIENTRY Msg(LPVOID lpParameter)
{
	...
	win = CreateWindowW(TEXT("BUTTON"), TEXT("跳关"), WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 685, 66, 50, 50, pro_hwnd, (HMENU)WINBUTTON, NULL, NULL);
	...
	SendMessage(unlock, WM_SETFONT, (WPARAM)宋体, TRUE);
